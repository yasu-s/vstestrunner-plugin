...
public class VsTestBuilder extends Builder {
	...
	public VsTestBuilder(String vsTestName, String testFiles, String settings, String tests, boolean enablecodecoverage
						,boolean inIsolation, boolean useVsixExtensions, String platform, String otherPlatform
						,String framework, String otherFramework, String testCaseFilter, String logger, String otherLogger
	...
	public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener) throws InterruptedException, IOException {
		...
		if (!isNullOrSpace(testFiles))
			args.addAll(getTestFilesArguments(build, listener, env));
	...
	private List<String> getTestFilesArguments(AbstractBuild<?, ?> build, BuildListener listener, EnvVars env) throws InterruptedException, IOException {
		ArrayList<String> args = new ArrayList<String>();
